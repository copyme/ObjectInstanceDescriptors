...
void usage()
{
    ...
    std::cout << "The input meshed element is sampled with user-specified density (number of samples per area unit)" << std::endl;
    std::cout << "Usage: sample -i mesh-element.ply -p point-set.ply -d density" << std::endl;
...
int main(int argc, char** argv)
{
    ...
    std::string out_file_name(mesh_file_name);
    out_file_name.append("-stats.txt");
    std::cout << "save stats to file " << out_file_name << "... ";
    std::ofstream out(out_file_name);
    out << "min distance: " << dmin << std::endl;
    out << "max distance: " << dmax << std::endl;
    out << "median distance: " << median << std::endl;
    out << "percentile 80 distance: " << p80 << std::endl;
    std::cout << "done" << std::endl;
