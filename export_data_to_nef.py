...
output_path_train = "Replace with the link to the nef cluster train folder"

output_path_val = "replace with the link to the nef cluster val folder"

output_path_test = "replace with the link to the nef cluster test folder"
